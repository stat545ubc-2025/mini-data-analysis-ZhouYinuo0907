...
ggplot(discount_review_summary, aes(x = discount_level, y = proportion, fill = review_level)) + 
  geom_col(position = "fill") + 
  labs(title = "Distribution of Review Level by Discount Level(High-priced games)", x = "Discount Level", y = "Proportion", fill = "Review Level") + 
  theme_minimal()
